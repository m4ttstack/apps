...
const PROJECTS_DEF = def({
  ...
  effective: { scope: "team", value: ["assured/assured-dev"], file: "team.jsonc" },
});
...
describe("SettingsPage", () => {
  it("sends the FULL array back on save when a string-array team key is edited, not a partial patch", () => {
    ...
    expect(set).toHaveBeenCalledWith("boxscore.projects", "team", ["assured/assured-dev", "other/project"]);
  });
