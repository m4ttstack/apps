> [!IMPORTANT]
> Development moved to [m4ttstack/apps](https://github.com/m4ttstack/apps) (`apps/boxscore`). This repo remains for release history until the mattstack.app bundle cutover, then archives.
