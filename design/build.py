...
{rail()}
  <div class="stack" style="flex: 1; min-width: 0;">
    ...
    <div class="row" style="height: 64px; flex: none; padding: 0 11.2px; background: var(--bg1); border-bottom: 1px solid var(--border); gap: 7.2px;">
      <svg width="24" height="24" viewBox="0 0 64 64" aria-hidden="true"><rect width="64" height="64" rx="14.4" fill="#161224"/><g transform="translate(7.04 13.4) scale(2.08)" fill="#FF6B9D"><path d="M6.5 2h11A4.5 4.5 0 0 1 22 6.5v5a4.5 4.5 0 0 1-4.5 4.5H13l-8.5 6.5L6 16a4.5 4.5 0 0 1-4-4.5v-5A4.5 4.5 0 0 1 6.5 2z"/></g></svg>
      <span style="font-size: 16px; font-weight: 700;">chat</span>
      <div style="flex: 1;"></div>
