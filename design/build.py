...
{field('Account', 'Assured · Fable 35% used', 'from cswap list · headroom beside each', chev=True)}
...
{field('Workspace', 'chat', 'herdr workspace the tab opens in · from chat.herdrWorkspace', chev=True)}
    ...
    <div class="row" style="gap: 7.2px; justify-content: flex-end; padding-top: 4.8px; border-top: 1px solid var(--border-soft);">
      <span class="hint" style="flex: 1;">runs <code style="font-family: inherit; font-size: 10.56px; background: var(--bg3); border: 1px solid var(--border-soft); border-radius: 3px; padding: 0 3px;">cswap run Assured --share-history -- claude --model claude-fable-5 --effort high</code> in a new tab · about 20s to idle</span>
